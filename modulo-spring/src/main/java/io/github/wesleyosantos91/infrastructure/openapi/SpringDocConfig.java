...
public class SpringDocConfig {
    ...
    public OpenAPI openAPIDefinition() {
        ...
        final Info info = new Info()
                ...
                .description("Desafio Técnico para estudo - Sistema de gerenciamento de pedidos")
    ...
    private License descriptionLicense() {
        return new License()
                .name("License")
                .url("https://github.com/wesleyosantos91/sistema-de-gerenciamento-de-pedidos/blob/main/LICENSE");
    }
